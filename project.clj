(defproject om-mutation "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "om-mutation.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main om-mutation.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "om-mutation.core/on-figwheel-reload"}

                :compiler {:main om-mutation.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/om_mutation.js"
